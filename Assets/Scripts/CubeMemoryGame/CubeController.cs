...
public class CubeController : MonoBehaviour
{
    ...
    public Action OnButtonPressed;  // ボタンが押されたときのイベント
    ...
    private bool isAnswerCorrect = false;  // 答えが正しいかどうか
    ...
    void Start()
    {
        ...
        SetColorButtonsActive(false);  // ボタンを非表示に設定
    }
    ...
    private void SelectColor(int index)
    {
        ...
        {
            Debug.LogError($"選択された色のインデックス {index} が範囲外です。");
            return;
        }
